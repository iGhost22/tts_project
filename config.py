...
# This class contains the configurations for the model, including audio, model, loss, dataloader, training, and testing configurations.
# The configurations are set in the constructor and can be accessed as attributes of the class.
class configurations(object):
	...
	# These configurations include the number of mel bands, frequency bins, sample rate, frame length and shift in milliseconds,
	...
	# Loss configurations
	# These configurations include the prior frequency, prior weight, and gate coefficient.
	...
	# These configurations include the batch size, number of workers, and whether to pin memory.
	def get_dataloader_config(self):
		self.pin_memory = True
		self.num_workers = cpu_count() # or just set 2

	# Training configurations
	# These configurations include the batch size, Adam optimizer parameters, learning rate, weight decay, and checkpoint interval.
