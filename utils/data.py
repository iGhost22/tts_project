...
# WRITE META DATA #
# This function writes the metadata to a file.
# It takes the following arguments:
# - metadata: The metadata to write to the file.
# - out_dir: The directory where the metadata file will be saved.
# - meta_text: The name of the metadata file.
# - frame_shift_ms: The frame shift in milliseconds.
# The function writes the metadata to a file in the specified directory.
...
def _process_utterance(out_dir, index, wav_path, text):
	...
	spectrogram_filename = 'metadata_spec_%05d.npy' % index
	mel_filename = 'metadata_mel_%05d.npy' % index
