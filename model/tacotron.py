...
# PRENET #
"""
	Prenet module: a feed-forward neural network composed of:
		- 2 linear layers
		- ReLU activation
		- Dropout
"""
...
# BATCH NORM CONV1D #
"""
	BatchNormConv1d module: a 1-d convolutional layer with batch normalization.
	It is used in the CBHG module.
	Args:
...
# HIGHWAY #
"""
	Highway module: a feed-forward neural network composed of:
		- 2 linear layers
		- ReLU activation
		- Sigmoid activation
		- Residual connection
...
# ENCODER #
"""
	Encoder module: a feed-forward neural network composed of:
		- Prenet
		- CBHG module
	Args:
		in_dim: input dimension
		sizes: list of sizes for the prenet
"""
...
# DECODER #
"""
	Decoder module: a recurrent neural network composed of:
		- Prenet
		- Attention RNN
		- Decoder RNNs
		- Linear projections
	Args:
		in_dim: input dimension
		r: number of frames to predict
		attention: attention mechanism to use (Bahdanau or LocationSensitive)
"""
...
# TACOTRON #
"""
	Tacotron module: a recurrent neural network composed of:
		- Encoder
		- Decoder
		- Postnet
	Args:
		n_vocab: number of vocabulary
		embedding_dim: dimension of the embedding layer
		mel_dim: dimension of the mel-spectrogram
		linear_dim: dimension of the linear output
		r: number of frames to predict
		padding_idx: padding index for the embedding layer
		attention: attention mechanism to use (Bahdanau or LocationSensitive)
		use_mask: whether to use mask for attention
"""
